...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("BASE_URL?q=".concat(term))];
                case 1:
                    results = _a.sent();
                    shows = results.data.map(function (show) {
                        show.id,
                            show.name,
                            show.summary,
                            show.image;
